...
public class Lang {
   ...
   public static String get(String key) {
      return cey.a(key, new Object[0]);
   }

   public static String get(String key, String def) {
      String str = cey.a(key, new Object[0]);
      return str != null && !str.equals(key) ? str : def;
   }

   public static String getOn() {
      return cey.a("options.on", new Object[0]);
   }

   public static String getOff() {
      return cey.a("options.off", new Object[0]);
   }

   public static String getFast() {
      return cey.a("options.graphics.fast", new Object[0]);
   }

   public static String getFancy() {
      return cey.a("options.graphics.fancy", new Object[0]);
   }

   public static String getDefault() {
      return cey.a("generator.default", new Object[0]);
   }
}
