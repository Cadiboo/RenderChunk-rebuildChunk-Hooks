...
public class Matches {
   public static boolean block(awp blockStateBase, MatchBlock[] matchBlocks) {
      if (matchBlocks == null) {
         return true;
      } else {
   ...
   public static boolean sprite(cdq sprite, cdq[] sprites) {
      if (sprites == null) {
         return true;
      } else {
   ...
   public static boolean biome(anh biome, anh[] biomes) {
      if (biomes == null) {
         return true;
      } else {
