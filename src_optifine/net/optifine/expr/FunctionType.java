...
public enum FunctionType {
   ...
   public float evalFloat(IExpression[] args) {
      ...
      case PI:
         return 3.1415927F;
      case SIN:
         return rk.a(evalFloat(args, 0));
      case COS:
         return rk.b(evalFloat(args, 0));
      case ASIN:
      ...
      case ATAN2:
         return (float)rk.c((double)evalFloat(args, 0), (double)evalFloat(args, 1));
      case TORAD:
      ...
      case CLAMP:
         return rk.a(evalFloat(args, 0), evalFloat(args, 1), evalFloat(args, 2));
      case ABS:
         return rk.e(evalFloat(args, 0));
      case EXP:
         return (float)Math.exp((double)evalFloat(args, 0));
      case FLOOR:
         return (float)rk.d(evalFloat(args, 0));
      case CEIL:
         return (float)rk.f(evalFloat(args, 0));
      case FRAC:
         return (float)rk.h((double)evalFloat(args, 0));
      case LOG:
      ...
      case SQRT:
         return rk.c(evalFloat(args, 0));
      case FMOD:
         float fmodX = evalFloat(args, 0);
         float fmodY = evalFloat(args, 1);
         return fmodX - fmodY * (float)rk.d(fmodX / fmodY);
      case TIME:
         bib mc = bib.z();
         amu world = mc.f;
         if (world == null) {
         ...
         return (float)(world.R() % 24000L) + mc.aj();
      case IF:
