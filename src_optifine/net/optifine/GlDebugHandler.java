...
public class GlDebugHandler implements Handler {
   public static void createDisplayDebug() throws LWJGLException {
      boolean debug = GLContext.getCapabilities().GL_ARB_debug_output;
      ContextAttribs ca = (new ContextAttribs()).withDebug(true);
      Display.create((new PixelFormat()).withDepthBits(24), ca);
