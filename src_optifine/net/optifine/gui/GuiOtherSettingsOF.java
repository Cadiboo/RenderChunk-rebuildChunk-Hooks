...
public class GuiOtherSettingsOF extends blk implements bkp {
   ...
   public void b() {
      this.title = cey.a("of.options.otherTitle", new Object[0]);
      this.n.clear();
      ...
      this.n.add(new bja(210, this.l / 2 - 100, this.m / 6 + 168 + 11 - 44, cey.a("of.options.other.reset", new Object[0])));
   ...
   protected void a(bja guibutton) {
      if (guibutton.l) {
         ...
         if (guibutton.k == 210) {
            this.j.t.b();
            bkq guiyesno = new bkq(this, cey.a("of.message.other.reset", new Object[0]), "", 9999);
            this.j.a(guiyesno);
         }
   ...
   static {
      enumOptions = new a[]{a.LAGOMETER, a.PROFILER, a.SHOW_FPS, a.ADVANCED_TOOLTIPS, a.WEATHER, a.TIME, a.v, a.FULLSCREEN_MODE, a.h, a.AUTOSAVE_TICKS, a.SCREENSHOT_SIZE, a.SHOW_GL_ERRORS};
   }
}
