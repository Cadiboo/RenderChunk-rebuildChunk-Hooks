...
public class RebuildChunkPreRenderSetupEvent extends RebuildChunkEvent {
	...
	public RenderChunkCache setRenderChunkCache(final RenderChunkCache renderChunkCache) {
		final RenderChunkCache oldRenderChunkCache = renderChunkCacheReference.get();
		renderChunkCacheReference.set(renderChunkCache);
		return oldRenderChunkCache;
	}
