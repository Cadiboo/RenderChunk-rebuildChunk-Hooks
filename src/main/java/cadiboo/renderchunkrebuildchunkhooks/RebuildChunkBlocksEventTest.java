...
public class RebuildChunkBlocksEventTest {
	...
	private static enum RebuildOptions {
		VANILLA, VANILLA_MODDED, FRAGMENTED, FACING, MARCHING_CUBES, SURFACE_NETS, SURFACE_NETS_OOP;
	}

	private static RebuildOptions[] rebuildOptions = new RebuildOptions[RebuildOptions.values().length];

	private static EnumFacing[] fragmentFacings = new EnumFacing[]{EnumFacing.DOWN, EnumFacing.UP};
	private static int fragmentRange;
	private static Random fragmentRandom = new Random();

	private static EnumFacing[] facingFacings = new EnumFacing[]{EnumFacing.NORTH, EnumFacing.SOUTH, EnumFacing.WEST, EnumFacing.EAST};
	...
	public static void rebuildChunkSetup(final RebuildChunkBlocksEvent event) {
		...
		fragmentFacings = new EnumFacing[]{EnumFacing.DOWN, EnumFacing.UP, EnumFacing.NORTH, EnumFacing.SOUTH, EnumFacing.WEST, EnumFacing.EAST};
		fragmentRange = 15;
		// fragmentRandom = new Random();

		facingFacings = new EnumFacing[]{EnumFacing.DOWN, EnumFacing.UP, EnumFacing.NORTH, EnumFacing.SOUTH, EnumFacing.WEST, EnumFacing.EAST,};
			...
			for (final BlockRenderLayer blockRenderLayer : BlockRenderLayer.values()) {
				...
				if (block.getDefaultState().getRenderType() != EnumBlockRenderType.INVISIBLE) {
					...
					for (final EnumFacing side : facingFacings) {
						final boolean used = renderBlockEnumFacing(iblockstate, blockpos$mutableblockpos, event.getWorldView(), bufferbuilder, event.getBlockRendererDispatcher(), true, side, false);
	...
	private static boolean renderBlockEnumFacing(IBlockState state, final BlockPos pos, final IBlockAccess blockAccess, final BufferBuilder bufferBuilderIn, final BlockRendererDispatcher blockRendererDispatcher, final boolean checkSides, final EnumFacing side, final boolean force) {
	...
	private static boolean renderFluid(final IBlockAccess blockAccess, final IBlockState stateIn, final BlockPos posIn, final BufferBuilder bufferBuilder, final boolean checkSides, final EnumFacing side, final boolean forceFull) {
	...
	private static float getFluidHeight(final IBlockAccess blockAccess, final BlockPos pos, final Material blockMaterial) {
		int divisor = 0;
	...
	private static boolean renderModel(final IBlockAccess blockAccessIn, final IBakedModel modelIn, final IBlockState blockStateIn, final BlockPos blockPosIn, final BufferBuilder buffer, final boolean checkSides, final EnumFacing side, final boolean force) {
	...
	private static boolean renderModel(final IBlockAccess worldIn, final IBakedModel modelIn, final IBlockState stateIn, final BlockPos posIn, final BufferBuilder buffer, final boolean checkSides, final EnumFacing side, final long rand, final boolean force) {
	...
	public static final int[] MARCHING_CUBES_EDGE_TABLE = new int[]{0x0, 0x109, 0x203, 0x30a, 0x406, 0x50f, 0x605, 0x70c, 0x80c, 0x905, 0xa0f, 0xb06, 0xc0a, 0xd03, 0xe09, 0xf00, 0x190, 0x99, 0x393, 0x29a, 0x596, 0x49f, 0x795, 0x69c, 0x99c, 0x895, 0xb9f, 0xa96, 0xd9a, 0xc93, 0xf99, 0xe90, 0x230, 0x339, 0x33, 0x13a, 0x636, 0x73f, 0x435, 0x53c, 0xa3c, 0xb35, 0x83f, 0x936, 0xe3a, 0xf33, 0xc39, 0xd30, 0x3a0, 0x2a9, 0x1a3, 0xaa, 0x7a6, 0x6af, 0x5a5, 0x4ac, 0xbac, 0xaa5, 0x9af, 0x8a6, 0xfaa, 0xea3, 0xda9, 0xca0,
			...
			0xd30, 0xc39, 0xf33, 0xe3a, 0x936, 0x83f, 0xb35, 0xa3c, 0x53c, 0x435, 0x73f, 0x636, 0x13a, 0x33, 0x339, 0x230, 0xe90, 0xf99, 0xc93, 0xd9a, 0xa96, 0xb9f, 0x895, 0x99c, 0x69c, 0x795, 0x49f, 0x596, 0x29a, 0x393, 0x99, 0x190, 0xf00, 0xe09, 0xd03, 0xc0a, 0xb06, 0xa0f, 0x905, 0x80c, 0x70c, 0x605, 0x50f, 0x406, 0x30a, 0x203, 0x109, 0x0};

	public static final int[][] MARCHING_CUBES_TRI_TABLE = new int[][]{new int[]{}, new int[]{0, 8, 3}, new int[]{0, 1, 9}, new int[]{1, 8, 3, 9, 8, 1}, new int[]{1, 2, 10}, new int[]{0, 8, 3, 1, 2, 10}, new int[]{9, 2, 10, 0, 2, 9}, new int[]{2, 8, 3, 2, 10, 8, 10, 9, 8}, new int[]{3, 11, 2}, new int[]{0, 11, 2, 8, 11, 0}, new int[]{1, 9, 0, 2, 3, 11}, new int[]{1, 11, 2, 1, 9, 11, 9, 8, 11}, new int[]{3, 10, 1, 11, 10, 3}, new int[]{0, 10, 1, 0, 8, 10, 8, 11, 10}, new int[]{3, 9, 0, 3, 11, 9, 11, 10, 9},
			new int[]{9, 8, 10, 10, 8, 11}, new int[]{4, 7, 8}, new int[]{4, 3, 0, 7, 3, 4}, new int[]{0, 1, 9, 8, 4, 7}, new int[]{4, 1, 9, 4, 7, 1, 7, 3, 1}, new int[]{1, 2, 10, 8, 4, 7}, new int[]{3, 4, 7, 3, 0, 4, 1, 2, 10}, new int[]{9, 2, 10, 9, 0, 2, 8, 4, 7}, new int[]{2, 10, 9, 2, 9, 7, 2, 7, 3, 7, 9, 4}, new int[]{8, 4, 7, 3, 11, 2}, new int[]{11, 4, 7, 11, 2, 4, 2, 0, 4}, new int[]{9, 0, 1, 8, 4, 7, 2, 3, 11}, new int[]{4, 7, 11, 9, 4, 11, 9, 11, 2, 9, 2, 1},
			new int[]{3, 10, 1, 3, 11, 10, 7, 8, 4}, new int[]{1, 11, 10, 1, 4, 11, 1, 0, 4, 7, 11, 4}, new int[]{4, 7, 8, 9, 0, 11, 9, 11, 10, 11, 0, 3}, new int[]{4, 7, 11, 4, 11, 9, 9, 11, 10}, new int[]{9, 5, 4}, new int[]{9, 5, 4, 0, 8, 3}, new int[]{0, 5, 4, 1, 5, 0}, new int[]{8, 5, 4, 8, 3, 5, 3, 1, 5}, new int[]{1, 2, 10, 9, 5, 4}, new int[]{3, 0, 8, 1, 2, 10, 4, 9, 5}, new int[]{5, 2, 10, 5, 4, 2, 4, 0, 2}, new int[]{2, 10, 5, 3, 2, 5, 3, 5, 4, 3, 4, 8}, new int[]{9, 5, 4, 2, 3, 11},
			new int[]{0, 11, 2, 0, 8, 11, 4, 9, 5}, new int[]{0, 5, 4, 0, 1, 5, 2, 3, 11}, new int[]{2, 1, 5, 2, 5, 8, 2, 8, 11, 4, 8, 5}, new int[]{10, 3, 11, 10, 1, 3, 9, 5, 4}, new int[]{4, 9, 5, 0, 8, 1, 8, 10, 1, 8, 11, 10}, new int[]{5, 4, 0, 5, 0, 11, 5, 11, 10, 11, 0, 3}, new int[]{5, 4, 8, 5, 8, 10, 10, 8, 11}, new int[]{9, 7, 8, 5, 7, 9}, new int[]{9, 3, 0, 9, 5, 3, 5, 7, 3}, new int[]{0, 7, 8, 0, 1, 7, 1, 5, 7}, new int[]{1, 5, 3, 3, 5, 7}, new int[]{9, 7, 8, 9, 5, 7, 10, 1, 2},
			new int[]{10, 1, 2, 9, 5, 0, 5, 3, 0, 5, 7, 3}, new int[]{8, 0, 2, 8, 2, 5, 8, 5, 7, 10, 5, 2}, new int[]{2, 10, 5, 2, 5, 3, 3, 5, 7}, new int[]{7, 9, 5, 7, 8, 9, 3, 11, 2}, new int[]{9, 5, 7, 9, 7, 2, 9, 2, 0, 2, 7, 11}, new int[]{2, 3, 11, 0, 1, 8, 1, 7, 8, 1, 5, 7}, new int[]{11, 2, 1, 11, 1, 7, 7, 1, 5}, new int[]{9, 5, 8, 8, 5, 7, 10, 1, 3, 10, 3, 11}, new int[]{5, 7, 0, 5, 0, 9, 7, 11, 0, 1, 0, 10, 11, 10, 0}, new int[]{11, 10, 0, 11, 0, 3, 10, 5, 0, 8, 0, 7, 5, 7, 0},
			new int[]{11, 10, 5, 7, 11, 5}, new int[]{10, 6, 5}, new int[]{0, 8, 3, 5, 10, 6}, new int[]{9, 0, 1, 5, 10, 6}, new int[]{1, 8, 3, 1, 9, 8, 5, 10, 6}, new int[]{1, 6, 5, 2, 6, 1}, new int[]{1, 6, 5, 1, 2, 6, 3, 0, 8}, new int[]{9, 6, 5, 9, 0, 6, 0, 2, 6}, new int[]{5, 9, 8, 5, 8, 2, 5, 2, 6, 3, 2, 8}, new int[]{2, 3, 11, 10, 6, 5}, new int[]{11, 0, 8, 11, 2, 0, 10, 6, 5}, new int[]{0, 1, 9, 2, 3, 11, 5, 10, 6}, new int[]{5, 10, 6, 1, 9, 2, 9, 11, 2, 9, 8, 11},
			new int[]{6, 3, 11, 6, 5, 3, 5, 1, 3}, new int[]{0, 8, 11, 0, 11, 5, 0, 5, 1, 5, 11, 6}, new int[]{3, 11, 6, 0, 3, 6, 0, 6, 5, 0, 5, 9}, new int[]{6, 5, 9, 6, 9, 11, 11, 9, 8}, new int[]{5, 10, 6, 4, 7, 8}, new int[]{4, 3, 0, 4, 7, 3, 6, 5, 10}, new int[]{1, 9, 0, 5, 10, 6, 8, 4, 7}, new int[]{10, 6, 5, 1, 9, 7, 1, 7, 3, 7, 9, 4}, new int[]{6, 1, 2, 6, 5, 1, 4, 7, 8}, new int[]{1, 2, 5, 5, 2, 6, 3, 0, 4, 3, 4, 7}, new int[]{8, 4, 7, 9, 0, 5, 0, 6, 5, 0, 2, 6},
			new int[]{7, 3, 9, 7, 9, 4, 3, 2, 9, 5, 9, 6, 2, 6, 9}, new int[]{3, 11, 2, 7, 8, 4, 10, 6, 5}, new int[]{5, 10, 6, 4, 7, 2, 4, 2, 0, 2, 7, 11}, new int[]{0, 1, 9, 4, 7, 8, 2, 3, 11, 5, 10, 6}, new int[]{9, 2, 1, 9, 11, 2, 9, 4, 11, 7, 11, 4, 5, 10, 6}, new int[]{8, 4, 7, 3, 11, 5, 3, 5, 1, 5, 11, 6}, new int[]{5, 1, 11, 5, 11, 6, 1, 0, 11, 7, 11, 4, 0, 4, 11}, new int[]{0, 5, 9, 0, 6, 5, 0, 3, 6, 11, 6, 3, 8, 4, 7}, new int[]{6, 5, 9, 6, 9, 11, 4, 7, 9, 7, 11, 9}, new int[]{10, 4, 9, 6, 4, 10},
			new int[]{4, 10, 6, 4, 9, 10, 0, 8, 3}, new int[]{10, 0, 1, 10, 6, 0, 6, 4, 0}, new int[]{8, 3, 1, 8, 1, 6, 8, 6, 4, 6, 1, 10}, new int[]{1, 4, 9, 1, 2, 4, 2, 6, 4}, new int[]{3, 0, 8, 1, 2, 9, 2, 4, 9, 2, 6, 4}, new int[]{0, 2, 4, 4, 2, 6}, new int[]{8, 3, 2, 8, 2, 4, 4, 2, 6}, new int[]{10, 4, 9, 10, 6, 4, 11, 2, 3}, new int[]{0, 8, 2, 2, 8, 11, 4, 9, 10, 4, 10, 6}, new int[]{3, 11, 2, 0, 1, 6, 0, 6, 4, 6, 1, 10}, new int[]{6, 4, 1, 6, 1, 10, 4, 8, 1, 2, 1, 11, 8, 11, 1},
			...
			new int[]{7, 3, 2, 6, 7, 2}, new int[]{2, 3, 11, 10, 6, 8, 10, 8, 9, 8, 6, 7}, new int[]{2, 0, 7, 2, 7, 11, 0, 9, 7, 6, 7, 10, 9, 10, 7}, new int[]{1, 8, 0, 1, 7, 8, 1, 10, 7, 6, 7, 10, 2, 3, 11}, new int[]{11, 2, 1, 11, 1, 7, 10, 6, 1, 6, 7, 1}, new int[]{8, 9, 6, 8, 6, 7, 9, 1, 6, 11, 6, 3, 1, 3, 6}, new int[]{0, 9, 1, 11, 6, 7}, new int[]{7, 8, 0, 7, 0, 6, 3, 11, 0, 11, 6, 0}, new int[]{7, 11, 6}, new int[]{7, 6, 11}, new int[]{3, 0, 8, 11, 7, 6}, new int[]{0, 1, 9, 11, 7, 6},
			new int[]{8, 1, 9, 8, 3, 1, 11, 7, 6}, new int[]{10, 1, 2, 6, 11, 7}, new int[]{1, 2, 10, 3, 0, 8, 6, 11, 7}, new int[]{2, 9, 0, 2, 10, 9, 6, 11, 7}, new int[]{6, 11, 7, 2, 10, 3, 10, 8, 3, 10, 9, 8}, new int[]{7, 2, 3, 6, 2, 7}, new int[]{7, 0, 8, 7, 6, 0, 6, 2, 0}, new int[]{2, 7, 6, 2, 3, 7, 0, 1, 9}, new int[]{1, 6, 2, 1, 8, 6, 1, 9, 8, 8, 7, 6}, new int[]{10, 7, 6, 10, 1, 7, 1, 3, 7}, new int[]{10, 7, 6, 1, 7, 10, 1, 8, 7, 1, 0, 8}, new int[]{0, 3, 7, 0, 7, 10, 0, 10, 9, 6, 10, 7},
			new int[]{7, 6, 10, 7, 10, 8, 8, 10, 9}, new int[]{6, 8, 4, 11, 8, 6}, new int[]{3, 6, 11, 3, 0, 6, 0, 4, 6}, new int[]{8, 6, 11, 8, 4, 6, 9, 0, 1}, new int[]{9, 4, 6, 9, 6, 3, 9, 3, 1, 11, 3, 6}, new int[]{6, 8, 4, 6, 11, 8, 2, 10, 1}, new int[]{1, 2, 10, 3, 0, 11, 0, 6, 11, 0, 4, 6}, new int[]{4, 11, 8, 4, 6, 11, 0, 2, 9, 2, 10, 9}, new int[]{10, 9, 3, 10, 3, 2, 9, 4, 3, 11, 3, 6, 4, 6, 3}, new int[]{8, 2, 3, 8, 4, 2, 4, 6, 2}, new int[]{0, 4, 2, 4, 6, 2},
			new int[]{1, 9, 0, 2, 3, 4, 2, 4, 6, 4, 3, 8}, new int[]{1, 9, 4, 1, 4, 2, 2, 4, 6}, new int[]{8, 1, 3, 8, 6, 1, 8, 4, 6, 6, 10, 1}, new int[]{10, 1, 0, 10, 0, 6, 6, 0, 4}, new int[]{4, 6, 3, 4, 3, 8, 6, 10, 3, 0, 3, 9, 10, 9, 3}, new int[]{10, 9, 4, 6, 10, 4}, new int[]{4, 9, 5, 7, 6, 11}, new int[]{0, 8, 3, 4, 9, 5, 11, 7, 6}, new int[]{5, 0, 1, 5, 4, 0, 7, 6, 11}, new int[]{11, 7, 6, 8, 3, 4, 3, 5, 4, 3, 1, 5}, new int[]{9, 5, 4, 10, 1, 2, 7, 6, 11},
			new int[]{6, 11, 7, 1, 2, 10, 0, 8, 3, 4, 9, 5}, new int[]{7, 6, 11, 5, 4, 10, 4, 2, 10, 4, 0, 2}, new int[]{3, 4, 8, 3, 5, 4, 3, 2, 5, 10, 5, 2, 11, 7, 6}, new int[]{7, 2, 3, 7, 6, 2, 5, 4, 9}, new int[]{9, 5, 4, 0, 8, 6, 0, 6, 2, 6, 8, 7}, new int[]{3, 6, 2, 3, 7, 6, 1, 5, 0, 5, 4, 0}, new int[]{6, 2, 8, 6, 8, 7, 2, 1, 8, 4, 8, 5, 1, 5, 8}, new int[]{9, 5, 4, 10, 1, 6, 1, 7, 6, 1, 3, 7}, new int[]{1, 6, 10, 1, 7, 6, 1, 0, 7, 8, 7, 0, 9, 5, 4},
			new int[]{4, 0, 10, 4, 10, 5, 0, 3, 10, 6, 10, 7, 3, 7, 10}, new int[]{7, 6, 10, 7, 10, 8, 5, 4, 10, 4, 8, 10}, new int[]{6, 9, 5, 6, 11, 9, 11, 8, 9}, new int[]{3, 6, 11, 0, 6, 3, 0, 5, 6, 0, 9, 5}, new int[]{0, 11, 8, 0, 5, 11, 0, 1, 5, 5, 6, 11}, new int[]{6, 11, 3, 6, 3, 5, 5, 3, 1}, new int[]{1, 2, 10, 9, 5, 11, 9, 11, 8, 11, 5, 6}, new int[]{0, 11, 3, 0, 6, 11, 0, 9, 6, 5, 6, 9, 1, 2, 10}, new int[]{11, 8, 5, 11, 5, 6, 8, 0, 5, 10, 5, 2, 0, 2, 5},
			new int[]{6, 11, 3, 6, 3, 5, 2, 10, 3, 10, 5, 3}, new int[]{5, 8, 9, 5, 2, 8, 5, 6, 2, 3, 8, 2}, new int[]{9, 5, 6, 9, 6, 0, 0, 6, 2}, new int[]{1, 5, 8, 1, 8, 0, 5, 6, 8, 3, 8, 2, 6, 2, 8}, new int[]{1, 5, 6, 2, 1, 6}, new int[]{1, 3, 6, 1, 6, 10, 3, 8, 6, 5, 6, 9, 8, 9, 6}, new int[]{10, 1, 0, 10, 0, 6, 9, 5, 0, 5, 6, 0}, new int[]{0, 3, 8, 5, 6, 10}, new int[]{10, 5, 6}, new int[]{11, 5, 10, 7, 5, 11}, new int[]{11, 5, 10, 11, 7, 5, 8, 3, 0}, new int[]{5, 11, 7, 5, 10, 11, 1, 9, 0},
			new int[]{10, 7, 5, 10, 11, 7, 9, 8, 1, 8, 3, 1}, new int[]{11, 1, 2, 11, 7, 1, 7, 5, 1}, new int[]{0, 8, 3, 1, 2, 7, 1, 7, 5, 7, 2, 11}, new int[]{9, 7, 5, 9, 2, 7, 9, 0, 2, 2, 11, 7}, new int[]{7, 5, 2, 7, 2, 11, 5, 9, 2, 3, 2, 8, 9, 8, 2}, new int[]{2, 5, 10, 2, 3, 5, 3, 7, 5}, new int[]{8, 2, 0, 8, 5, 2, 8, 7, 5, 10, 2, 5}, new int[]{9, 0, 1, 5, 10, 3, 5, 3, 7, 3, 10, 2}, new int[]{9, 8, 2, 9, 2, 1, 8, 7, 2, 10, 2, 5, 7, 5, 2}, new int[]{1, 3, 5, 3, 7, 5},
			new int[]{0, 8, 7, 0, 7, 1, 1, 7, 5}, new int[]{9, 0, 3, 9, 3, 5, 5, 3, 7}, new int[]{9, 8, 7, 5, 9, 7}, new int[]{5, 8, 4, 5, 10, 8, 10, 11, 8}, new int[]{5, 0, 4, 5, 11, 0, 5, 10, 11, 11, 3, 0}, new int[]{0, 1, 9, 8, 4, 10, 8, 10, 11, 10, 4, 5}, new int[]{10, 11, 4, 10, 4, 5, 11, 3, 4, 9, 4, 1, 3, 1, 4}, new int[]{2, 5, 1, 2, 8, 5, 2, 11, 8, 4, 5, 8}, new int[]{0, 4, 11, 0, 11, 3, 4, 5, 11, 2, 11, 1, 5, 1, 11}, new int[]{0, 2, 5, 0, 5, 9, 2, 11, 5, 4, 5, 8, 11, 8, 5},
			new int[]{9, 4, 5, 2, 11, 3}, new int[]{2, 5, 10, 3, 5, 2, 3, 4, 5, 3, 8, 4}, new int[]{5, 10, 2, 5, 2, 4, 4, 2, 0}, new int[]{3, 10, 2, 3, 5, 10, 3, 8, 5, 4, 5, 8, 0, 1, 9}, new int[]{5, 10, 2, 5, 2, 4, 1, 9, 2, 9, 4, 2}, new int[]{8, 4, 5, 8, 5, 3, 3, 5, 1}, new int[]{0, 4, 5, 1, 0, 5}, new int[]{8, 4, 5, 8, 5, 3, 9, 0, 5, 0, 3, 5}, new int[]{9, 4, 5}, new int[]{4, 11, 7, 4, 9, 11, 9, 10, 11}, new int[]{0, 8, 3, 4, 9, 7, 9, 11, 7, 9, 10, 11}, new int[]{1, 10, 11, 1, 11, 4, 1, 4, 0, 7, 4, 11},
			new int[]{3, 1, 4, 3, 4, 8, 1, 10, 4, 7, 4, 11, 10, 11, 4}, new int[]{4, 11, 7, 9, 11, 4, 9, 2, 11, 9, 1, 2}, new int[]{9, 7, 4, 9, 11, 7, 9, 1, 11, 2, 11, 1, 0, 8, 3}, new int[]{11, 7, 4, 11, 4, 2, 2, 4, 0}, new int[]{11, 7, 4, 11, 4, 2, 8, 3, 4, 3, 2, 4}, new int[]{2, 9, 10, 2, 7, 9, 2, 3, 7, 7, 4, 9}, new int[]{9, 10, 7, 9, 7, 4, 10, 2, 7, 8, 7, 0, 2, 0, 7}, new int[]{3, 7, 10, 3, 10, 2, 7, 4, 10, 1, 10, 0, 4, 0, 10}, new int[]{1, 10, 2, 8, 7, 4}, new int[]{4, 9, 1, 4, 1, 7, 7, 1, 3},
			new int[]{4, 9, 1, 4, 1, 7, 0, 8, 1, 8, 7, 1}, new int[]{4, 0, 3, 7, 4, 3}, new int[]{4, 8, 7}, new int[]{9, 10, 8, 10, 11, 8}, new int[]{3, 0, 9, 3, 9, 11, 11, 9, 10}, new int[]{0, 1, 10, 0, 10, 8, 8, 10, 11}, new int[]{3, 1, 10, 11, 3, 10}, new int[]{1, 2, 11, 1, 11, 9, 9, 11, 8}, new int[]{3, 0, 9, 3, 9, 11, 1, 2, 9, 2, 11, 9}, new int[]{0, 2, 11, 8, 0, 11}, new int[]{3, 2, 11}, new int[]{2, 3, 8, 2, 8, 10, 10, 8, 9}, new int[]{9, 10, 2, 0, 9, 2},
			new int[]{2, 3, 8, 2, 8, 10, 0, 1, 8, 1, 10, 8}, new int[]{1, 10, 2}, new int[]{1, 3, 8, 9, 1, 8}, new int[]{0, 9, 1}, new int[]{0, 3, 8}, {}};
	...
	public static void rebuildChunkMarchingCubes(final RebuildChunkBlocksEvent event) {
		...
		final int[] c = new int[]{event.getPosition().getX(), event.getPosition().getY(), event.getPosition().getZ()};
		...
		for (x[2] = 0; x[2] < (dims[2] - 1); ++x[2], n += dims[0]) {
			for (x[1] = 0; x[1] < (dims[1] - 1); ++x[1], ++n) {
				for (x[0] = 0; x[0] < (dims[0] - 1); ++x[0], ++n) {
					...
					for (int k = 0; k < 2; ++k, idx += dims[0] * (dims[1] - 2)) {
						for (int j = 0; j < 2; ++j, idx += dims[0] - 2) {
							for (int i = 0; i < 2; ++i, ++g, ++idx) {
								// float p = data[idx];
								final float p = getBlockDensity(new BlockPos(c[0] + x[0] + i, c[1] + x[1] + j, c[2] + x[2] + k), cache);
								grid[g] = p;
					...
					// }
					// Compute vertices
					final int edge_mask = MARCHING_CUBES_EDGE_TABLE[cube_index];
					...
					for (int i = 0; i < 12; ++i) {
						...
						final int[] e = MARCHING_CUBES_EDGE_INDEX[i];
						final int[] p0 = MARCHING_CUBES_CUBE_VERTS[e[0]];
						final int[] p1 = MARCHING_CUBES_CUBE_VERTS[e[1]];
					...
					// Add faces
					final int[] f = MARCHING_CUBES_TRI_TABLE[cube_index];
	...
	@SubscribeEvent
	public static void rebuildChunkSurfaceNets(final RebuildChunkBlocksEvent event) {
		if (!ENABLED) {
			return;
		}

		if (!Arrays.asList(rebuildOptions).contains(RebuildOptions.SURFACE_NETS)) {
			return;
		}

		final ChunkCache cache = event.getWorldView();
		final BlockPos position = event.getPosition();
				...
				if (state.getValue(BlockLiquid.LEVEL) == 0) {
					...
					if (shouldExtend) {
						for (final EnumFacing facing : EnumFacing.VALUES) {
							...
							if (!shouldSmooth(cache.getBlockState(offset))) {
								continue;
							}
		...
		for (final BlockPos pos : redoPositions.keySet()) {
			...
			if (((pos.getX() << 4) != (position.getX() << 4)) || ((pos.getY() << 4) != (position.getY() << 4))) {
				continue;
			}
			...
			for (final BlockRenderLayer blockRenderLayer : BlockRenderLayer.values()) {
				...
				if (state.getRenderType() != EnumBlockRenderType.INVISIBLE) {
					...
					if (!(block instanceof BlockLiquid)) {
						...
						shouldRenderTop = state.shouldSideBeRendered(cache, pos, EnumFacing.UP) || ((cache.getBlockState(pos.offset(EnumFacing.UP)).getMaterial() != state.getMaterial()) && !shouldSmooth(cache.getBlockState(pos.offset(EnumFacing.UP))));
						shouldRenderBottom = state.shouldSideBeRendered(cache, pos, EnumFacing.DOWN) || ((cache.getBlockState(pos.offset(EnumFacing.DOWN)).getMaterial() != state.getMaterial()) && !shouldSmooth(cache.getBlockState(pos.offset(EnumFacing.DOWN))));
						shouldRenderSide = new boolean[]{state.shouldSideBeRendered(cache, pos, EnumFacing.NORTH) || ((cache.getBlockState(pos.offset(EnumFacing.NORTH)).getMaterial() != state.getMaterial()) && !shouldSmooth(cache.getBlockState(pos.offset(EnumFacing.NORTH)))), state.shouldSideBeRendered(cache, pos, EnumFacing.SOUTH) || ((cache.getBlockState(pos.offset(EnumFacing.SOUTH)).getMaterial() != state.getMaterial()) && !shouldSmooth(cache.getBlockState(pos.offset(EnumFacing.SOUTH)))),
								state.shouldSideBeRendered(cache, pos, EnumFacing.WEST) || ((cache.getBlockState(pos.offset(EnumFacing.WEST)).getMaterial() != state.getMaterial()) && !shouldSmooth(cache.getBlockState(pos.offset(EnumFacing.WEST)))), state.shouldSideBeRendered(cache, pos, EnumFacing.EAST) || ((cache.getBlockState(pos.offset(EnumFacing.EAST)).getMaterial() != state.getMaterial()) && !shouldSmooth(cache.getBlockState(pos.offset(EnumFacing.EAST))))};

						boolean didRenderFluid = false;
						final Material material = state.getMaterial();
						float fluidHeight = getFluidHeight(cache, pos, material);
						float fluidHeightSouth = getFluidHeight(cache, pos.south(), material);
						float fluidHeightEastSouth = getFluidHeight(cache, pos.east().south(), material);
						float fluidHeightEast = getFluidHeight(cache, pos.east(), material);
						if (true) {
							fluidHeight = 0.8888889F;
							fluidHeightSouth = 0.8888889F;
							fluidHeightEastSouth = 0.8888889F;
	...
	public static void rebuildChunkSurfaceNetsOOP(final RebuildChunkBlocksEvent event) {
		...
		if (!Arrays.asList(rebuildOptions).contains(RebuildOptions.SURFACE_NETS_OOP)) {
			return;
		}
