...
final class RenderGrass$render$$inlined$renderAs$lambda$4 extends Lambda implements Function2 {
   // $FF: synthetic field
   ...
   RenderGrass$render$$inlined$renderAs$lambda$4(BufferBuilder var1, List var2, GrassInfo var3, boolean var4, int var5) {
      super(2);
