...
final class RenderLeaves$render$$inlined$leaves$lambda$6 extends Lambda implements Function3 {
   // $FF: synthetic field
   final Integer[] $rand;
   // $FF: synthetic field
   ...
   RenderLeaves$render$$inlined$leaves$lambda$6(Integer[] var1, RenderLeaves var2, BlockContext var3, BufferBuilder var4, LeafInfo var5, int var6, boolean var7) {
      super(3);
      this.$rand = var1;
      this.this$0 = var2;
