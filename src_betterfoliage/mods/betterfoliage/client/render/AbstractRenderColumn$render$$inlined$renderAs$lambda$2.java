...
final class AbstractRenderColumn$render$$inlined$renderAs$lambda$2 extends Lambda implements Function6 {
   // $FF: synthetic field
   final BooleanRef $isLidDown;
   // $FF: synthetic field
   final int $idx;
   // $FF: synthetic field
   ...
   public final void invoke(@NotNull RenderVertex $receiver, @NotNull ShadingContext $noName_1, int $noName_2, @NotNull Quad $noName_3, int $noName_4, @NotNull Vertex $noName_5) {
      ...
      if (this.$isLidDown.element) {
         int n$iv = (Intrinsics.areEqual(this.$logAxis$inlined, Axis.X) ? 0 : 3) - this.$idx;
         double t$iv;
         switch(n$iv % 4) {
         case 1:
            t$iv = $receiver.getV();
