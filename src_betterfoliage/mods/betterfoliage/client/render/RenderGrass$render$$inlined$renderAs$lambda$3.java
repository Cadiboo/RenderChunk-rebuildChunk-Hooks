...
final class RenderGrass$render$$inlined$renderAs$lambda$3 extends Lambda implements Function6 {
   // $FF: synthetic field
   ...
   RenderGrass$render$$inlined$renderAs$lambda$3(BufferBuilder var1, List var2, GrassInfo var3, boolean var4, int var5) {
      super(6);
