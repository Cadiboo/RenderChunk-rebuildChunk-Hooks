...
final class RenderLeaves$render$$inlined$leaves$lambda$4 extends Lambda implements Function3 {
   // $FF: synthetic field
   ...
   RenderLeaves$render$$inlined$leaves$lambda$4(Integer[] var1, RenderLeaves var2, BlockContext var3, BufferBuilder var4, LeafInfo var5, int var6, boolean var7) {
      super(3);
   ...
   public final TextureAtlasSprite invoke(@NotNull ShadingContext $noName_0, int $noName_1, @NotNull Quad $noName_2) {
      ...
      return this.$leafInfo$inlined.getRoundLeafTexture();
   }
}
