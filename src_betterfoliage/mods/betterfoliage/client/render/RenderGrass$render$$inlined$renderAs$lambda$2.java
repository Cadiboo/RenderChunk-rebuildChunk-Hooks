...
final class RenderGrass$render$$inlined$renderAs$lambda$2 extends Lambda implements Function3 {
   // $FF: synthetic field
   ...
   RenderGrass$render$$inlined$renderAs$lambda$2(BufferBuilder var1, List var2, GrassInfo var3, boolean var4, int var5) {
      super(3);
